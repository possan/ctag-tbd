...
esp_err_t MacroAPI::macroapi_get_handler(httpd_req_t *req) {
    ...
    //     httpd_query_key_value(query, "track", action, sizeof(action));
    //     free(query);
    // }
    ...
    // Document doc3(kObjectType);
    // CTAG::AUDIO::SoundProcessorManager::macroSoundDefinitionModel->SerializeListInto(trackIndex, doc3);
    // resp.AddMember("presetgroups", doc3["presetgroups"], alloc);
