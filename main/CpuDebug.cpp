...
// #include "Midi.hpp"
// #else
//     uint8_t CTAG::CPUDebug::Control::trig_data[N_TRIGS];
//     float CTAG::CPUDebug::Control::cv_data[N_CVS];
// #endif

// IRAM_ATTR void CTAG::CPUDebug::Control::Update(uint8_t **trigs, float **cvs) {
...
// void CTAG::CPUDebug::Control::SetCVChannelBiPolar(const bool &v0, const bool &v1, const bool &v2, const bool &v3) {
...
TaskHandle_t CTAG::CTRL::CPUDebug::taskHandle;

void  CTAG::CTRL::CPUDebug::task(void *params) {
        static char buf[1024];
    while (true) {
        vTaskGetRunTimeStats(buf);

        ESP_LOGW("CPUDebug", "%s", buf);
...
void CTAG::CTRL::CPUDebug::Init() {
    ESP_LOGI("CPUDebug", "Initializing cpu debug");

    xTaskCreate(&CPUDebug::task, "led_task", 4096, nullptr, 5, &taskHandle);
...
// void CTAG::CPUDebug::Control::FlushBuffers() {
