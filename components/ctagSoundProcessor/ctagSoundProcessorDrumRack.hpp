...
#include "drumrack/DrumRackTD3.hpp"
...
namespace CTAG {
    namespace SP {
        ...
        private:
			...
			DrumRackRimshot rs_1;
			DrumRackRimshot rs_2;
			...
			DrumRackPolyPad pp_1;
			DrumRackPolyPad pp_2;

			DrumRackRompler ro_1;
			DrumRackRompler ro_2;
			DrumRackRompler ro_3;
			DrumRackRompler ro_4;
			DrumRackRompler ro_5;
			DrumRackRompler ro_6;
