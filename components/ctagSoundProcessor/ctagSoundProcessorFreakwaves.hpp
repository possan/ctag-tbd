...
namespace CTAG {
    namespace SP {
        ...
        private:
            ...
            // sectionHpp
	atomic<int32_t> GateA, trig_GateA;
	atomic<int32_t> GateB, trig_GateB;
	atomic<int32_t> MasterPitch, cv_MasterPitch;
	atomic<int32_t> MasterTune, cv_MasterTune;
	atomic<int32_t> CoutOnRightCh, trig_CoutOnRightCh;
	atomic<int32_t> QuantInputA, trig_QuantInputA;
	atomic<int32_t> Qscale_A, cv_Qscale_A;
	atomic<int32_t> QuantInputB, trig_QuantInputB;
	atomic<int32_t> Qscale_B, cv_Qscale_B;
	atomic<int32_t> Qscale_C, cv_Qscale_C;
	atomic<int32_t> PortaA, trig_PortaA;
	atomic<int32_t> PortamentoTimeA, cv_PortamentoTimeA;
	atomic<int32_t> PortaB, trig_PortaB;
	atomic<int32_t> PortamentoTimeB, cv_PortamentoTimeB;
	atomic<int32_t> PortaC, trig_PortaC;
	atomic<int32_t> PortamentoTimeC, cv_PortamentoTimeC;
	atomic<int32_t> Vol_A, cv_Vol_A;
	atomic<int32_t> Vol_B, cv_Vol_B;
	atomic<int32_t> Vol_C, cv_Vol_C;
	atomic<int32_t> Vol_Ext, cv_Vol_Ext;
	atomic<int32_t> ExternalWet, cv_ExternalWet;
	atomic<int32_t> BalanceAB_C, cv_BalanceAB_C;
	...
	atomic<int32_t> WaveTblB, cv_WaveTblB;
	atomic<int32_t> ScanWavTblB, cv_ScanWavTblB;
	...
	atomic<int32_t> relative_tune_C, cv_relative_tune_C;
	atomic<int32_t> GeneratePitchC, trig_GeneratePitchC;
	atomic<int32_t> CnotAorB, trig_CnotAorB;
	atomic<int32_t> ChooseBforNot, trig_ChooseBforNot;
	atomic<int32_t> UseABGate, trig_UseABGate;
	atomic<int32_t> GateForCisB, trig_GateForCisB;
	atomic<int32_t> LFOspeedC, cv_LFOspeedC;
	atomic<int32_t> LFOamountC, cv_LFOamountC;
	atomic<int32_t> ExtModCisOn, trig_ExtModCisOn;
	atomic<int32_t> ExtModGain, cv_ExtModGain;
	atomic<int32_t> AmountForExternalMod, cv_AmountForExternalMod;
	atomic<int32_t> ExternalDetectToRelease, trig_ExternalDetectToRelease;
	atomic<int32_t> AccentModCisOn, trig_AccentModCisOn;
	atomic<int32_t> DetectAccentLevel, cv_DetectAccentLevel;
	atomic<int32_t> AmountForAccentMod, cv_AmountForAccentMod;
	atomic<int32_t> AccentToScanC, trig_AccentToScanC;
	atomic<int32_t> KeytrackModCisOn, trig_KeytrackModCisOn;
	atomic<int32_t> KeytrackingLevel, cv_KeytrackingLevel;
	atomic<int32_t> KeytrackSlew, trig_KeytrackSlew;
	atomic<int32_t> KeytrackingToEcho, trig_KeytrackingToEcho;
	atomic<int32_t> EGvolActive_A, trig_EGvolActive_A;
	atomic<int32_t> EGvolSlow_A, trig_EGvolSlow_A;
	atomic<int32_t> AttackVol_A, cv_AttackVol_A;
	atomic<int32_t> DecayVol_A, cv_DecayVol_A;
	atomic<int32_t> SustainVol_A, cv_SustainVol_A;
	atomic<int32_t> ReleaseVol_A, cv_ReleaseVol_A;
	atomic<int32_t> EGvolActive_B, trig_EGvolActive_B;
	atomic<int32_t> EGvolSlow_B, trig_EGvolSlow_B;
	atomic<int32_t> AttackVol_B, cv_AttackVol_B;
	atomic<int32_t> DecayVol_B, cv_DecayVol_B;
	atomic<int32_t> SustainVol_B, cv_SustainVol_B;
	atomic<int32_t> ReleaseVol_B, cv_ReleaseVol_B;
	atomic<int32_t> EGvolActive_C, trig_EGvolActive_C;
	atomic<int32_t> EGvolSlow_C, trig_EGvolSlow_C;
	atomic<int32_t> AttackVol_C, cv_AttackVol_C;
	atomic<int32_t> DecayVol_C, cv_DecayVol_C;
	atomic<int32_t> SustainVol_C, cv_SustainVol_C;
	atomic<int32_t> ReleaseVol_C, cv_ReleaseVol_C;
	atomic<int32_t> DelayEnable, trig_DelayEnable;
	atomic<int32_t> AddDelayAfterResonator, trig_AddDelayAfterResonator;
	...
	atomic<int32_t> ResonatorOn, trig_ResonatorOn;
	atomic<int32_t> ResonatorDryWet, cv_ResonatorDryWet;
	atomic<int32_t> WaveShaperDryWet, cv_WaveShaperDryWet;
	atomic<int32_t> ResonatorPosition, cv_ResonatorPosition;
	atomic<int32_t> ResonatorFreq, cv_ResonatorFreq;
	atomic<int32_t> ResonatorStructure, cv_ResonatorStructure;
	atomic<int32_t> ResonatorBrightness, cv_ResonatorBrightness;
	atomic<int32_t> ResonatorDamping, cv_ResonatorDamping;
	...
	atomic<int32_t> lfoActive_6, trig_lfoActive_6;
	atomic<int32_t> lfoDestination_6, cv_lfoDestination_6;
	atomic<int32_t> lfoType_6, cv_lfoType_6;
	atomic<int32_t> lfoSpeed_6, cv_lfoSpeed_6;
	atomic<int32_t> lfoAmnt_6, cv_lfoAmnt_6;
	atomic<int32_t> lfoActive_7, trig_lfoActive_7;
	atomic<int32_t> lfoDestination_7, cv_lfoDestination_7;
	atomic<int32_t> lfoType_7, cv_lfoType_7;
	atomic<int32_t> lfoSpeed_7, cv_lfoSpeed_7;
	atomic<int32_t> lfoAmnt_7, cv_lfoAmnt_7;
	// sectionHpp
        };
    }
}