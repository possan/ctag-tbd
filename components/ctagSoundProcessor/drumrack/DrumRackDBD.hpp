...
private:
	...
	atomic<int16_t> db_mute, trig_db_mute;
	atomic<int16_t> db_lev, cv_db_lev;
	atomic<int16_t> db_pan, cv_db_pan;
	atomic<int16_t> db_fx1, cv_db_fx1;
	atomic<int16_t> db_fx2, cv_db_fx2;
